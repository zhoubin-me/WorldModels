...
class EvolutionModule:
    ...
    def run(self, iterations, print_step=10):
        for iteration in range(iterations):
            ...
            def get_reward(pop):
                return self.reward_function(self.jitter_weights(copy.deepcopy(self.weights), pop))

            rewards = Parallel(n_jobs=40, verbose=0)(delayed(get_reward)(pop) for pop in population)
